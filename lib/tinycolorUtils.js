...
export function produceRgbShades (r, g, b, amount) {
  ...
  for (let i = 6; i > 1; i -= 5 / amount) { // Decrements from 9 - 1; i being what luminosity (hsl.l) is multiplied by.
    hsl.l = 0.1 * i
...
export function colorToRgbObj (color) { // TODO: Note which colors tinycolor() can take; i.e. hex / rgb strings, objects, etc.
